...
def button():
	BUTTON=[[InlineKeyboardButton(text="👨🏻‍💻 Sahibim ",url="t.me/ruhsuzbeyyy")]]
	BUTTON+=[[InlineKeyboardButton(text="🌱 Reklam 🌱",url="t.me/Alem_Sohbet")]]
...
async def _(client, message):
	...
	await message.reply_text(text="**Merhaba {}!**\n\n__Ben Pyrogram Api İle Yazılmış Eğlence Botuyum :)__\n\n**grubuna eklemek için  =>** [✅](yönetici olarak ekleyin)\nDoğruluk mu? Cesaret mi? Oyunu başlatmak için => /dc".format(
